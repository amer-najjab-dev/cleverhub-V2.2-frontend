    ...
    const fetchClient = async () => {
      try {
        ...
        setFormData({
          ...
          birth_date: client.birth_date ? new 
Date(client.birth_date).toISOString().split('T')[0] : '',
...
value
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.error(error.response?.data?.message || 'Error al actualizar el 
cliente');
    } finally {
      setSaving(false);
    }
...
p-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            <h2 className="text-lg font-semibold text-gray-900 border-b 
pb-2">Información Personal</h2>
...
focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 
mb-1">Fecha de Nacimiento</label>
              <input
                type="date"
                name="birth_date"
...
focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 
mb-1">Condiciones Crónicas</label>
              <textarea
